...
function proxiedStreamUrl(url) {
  return url;   // direct FanCode URL; Referer is injected by hls.js xhrSetup
}
...
function playChannel(ch) {
  ...
  if (Hls.isSupported()) {
    ...
    hls = new Hls({
      ...
      /* Inject FanCode-required headers on every XHR request */
      xhrSetup(xhr, url) {
        xhr.withCredentials = false;
        xhr.setRequestHeader("Referer",  "https://www.fancode.com/");
        xhr.setRequestHeader("Origin",   "https://www.fancode.com");
      },
    });
